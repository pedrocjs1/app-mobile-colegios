...
export default function TutorDashboard() {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#F0F2F5' }}>
            ...
            <View style={[styles.header, { backgroundColor: theme.primary }]}>
                <View style={styles.headerTop}>
                    <View style={styles.profileBox}>
                        ...
                        <View>
                            <Text style={styles.welcomeText}>Flia. {user?.name.split(' ')[1] || 'Gomez'}</Text>
            ...
            {/* Sección Ausencias (Tarjetas de colores) */}
            <View style={{ padding: 20 }}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flexDirection: 'row' }}>
                    ...
                    <View style={[styles.statusCard, { backgroundColor: '#EC4899' }]}>
                        <Image source={{ uri: 'https://i.pravatar.cc/150?img=5' }} style={styles.miniAvatar} />
                        <Text style={styles.statusNumber}>0</Text>
                        <View style={styles.statusLabel}><Text style={styles.statusLabelText}>Sofia Gómez</Text></View>
                    </View>
                </ScrollView>
            </View>

            {/* Sección Sanciones (Lista Detallada) */}
            <View style={{ px: 20 }}>
                <Text style={styles.sectionTitle}>Sanciones (2)</Text>
                <View style={styles.listCard}>
                    <View style={styles.listItem}>
                        <View style={[styles.iconBox, { backgroundColor: '#FEE2E2' }]}><AlertCircle size={20} color="#EF4444" /></View>
                        <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
    header: { paddingTop: 60, paddingBottom: 30, px: 20, borderBottomLeftRadius: 35, borderBottomRightRadius: 35 },
    headerTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    profileBox: { flexDirection: 'row', alignItems: 'center' },
    avatar: { width: 50, height: 50, borderRadius: 15, marginRight: 12, borderSize: 2, borderColor: 'white' },
    ...
    miniAvatar: { width: 45, height: 45, borderRadius: 15, borderSize: 2, borderColor: 'white' },
    ...
    listCard: { backgroundColor: 'white', borderRadius: 25, padding: 15, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10 },
    listItem: { flexDirection: 'row', alignItems: 'center', mb: 10 },
    iconBox: { p: 10, borderRadius: 15, mr: 15 },
