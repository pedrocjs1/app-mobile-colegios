...
try {
    ...
    elseif ($nodeMajor -lt 20) {
        Write-Host "⚠️  Node.js $nodeVersion detectado. Recomendamos 20.x para mejor compatibilidad." -ForegroundColor Yellow
    }
}
catch {
...
Write-Host "🗑️  Paso 2/4: Eliminando node_modules existente..." -ForegroundColor Yellow
